...
function renderLandingPageTemplate(helpers) {
  const contactHref = helpers.relativePagePath(ROUTES.contact);
  const docsHref = helpers.relativePagePath(ROUTES.docs);
  const blogsHref = helpers.relativePagePath(ROUTES.blogs);
  const getStartedHref = helpers.relativePagePath("docs/getting-started/index.html");
  const useCasesHref = helpers.relativePagePath(ROUTES.usecaseSaas);
  ...
  return `
    ...
    <div class="stats-bar">
      <div class="container">
        ...
        <div class="stat-item"><div class="stat-num">3 min</div><div class="stat-label">Average integration time</div></div>
        <div class="stat-item"><div class="stat-num">99.9%</div><div class="stat-label">Deployment reliability</div></div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="compare-grid">
          <div class="compare-card diy">
            ...
            <ul class="compare-list">
              <li><span class="check no"></span><span>Design OAuth flows from scratch</span></li>
              <li><span class="check no"></span><span>Build user, role, and tenant management</span></li>
          ...
          <div class="compare-card idp">
            ...
            <ul class="compare-list">
              ...
              <li><span class="check yes"><svg viewBox="0 0 10 10" fill="none"><path d="M2 5l2.5 2.5L8 3" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg></span><span>Built-in user, role, and tenant management</span></li>
              ...
              <li><span class="check yes"><svg viewBox="0 0 10 10" fill="none"><path d="M2 5l2.5 2.5L8 3" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg></span><span>MFA and security policies included</span></li>
    ...
    <section>
      <div class="container">
        <div class="section-label">Architecture</div>
        <h2>How It Works</h2>
        <p class="section-intro">Your application delegates authentication to the Identity Platform while keeping full control of business logic. The platform issues tokens and clients use those tokens to access your APIs.</p>
      ...
      <div class="container">
        ...
        <div class="dashboard-preview">
          <div class="dash-header">
            ...
            <span class="dash-title">TokenIDP Admin Dashboard</span>
          </div>
          <div class="dash-body">
            ...
            <div class="dash-main">
              ...
              <div class="chart-area">
                <h4>// token volume - last 7 days</h4>
                <div class="bar-chart">
    ...
    <section class="cta-section">
      <div class="container cta-inner">
        ...
        <div class="cta-btns">
          <a href="${getStartedHref}" class="btn-primary-inv">Get Started</a>
          <a href="${contactHref}" class="btn-ghost-inv">Schedule a Demo</a>
        </div>
      </div>
    </section>
    `;
...
function renderLandingPageTemplateFooter(helpers) {
  const docsHref = helpers.relativePagePath(ROUTES.docs);
  const blogsHref = helpers.relativePagePath(ROUTES.blogs);
  const contactHref = helpers.relativePagePath(ROUTES.contact);
  const getStartedHref = helpers.relativePagePath("docs/getting-started/index.html");
        ...
        <div class="footer-top">
          ...
          <div class="footer-col">
            ...
            <ul>
              ...
              <li><a href="${getStartedHref}">Get Started</a></li>
            </ul>
          </div>
          <div class="footer-col">
            <h5>Resources</h5>
            <ul>
              ...
              <li><a href="${contactHref}">Schedule a Demo</a></li>
            </ul>
          </div>
          <div class="footer-col">
            <h5>Company</h5>
...
function renderLandingPageBody(helpers) {
  const homeHref = helpers.relativePagePath(ROUTES.home);
  const docsHref = helpers.relativePagePath(ROUTES.docs);
  const blogsHref = helpers.relativePagePath(ROUTES.blogs);
  const contactHref = helpers.relativePagePath(ROUTES.contact);
  const getStartedHref = helpers.relativePagePath("docs/getting-started/index.html");
  const featuresHref = `${homeHref}#features`;
  const usecaseSaasHref = helpers.relativePagePath(ROUTES.usecaseSaas);
  const usecaseComplianceHref = helpers.relativePagePath(ROUTES.usecaseCompliance);
  const usecaseApiHref = helpers.relativePagePath(ROUTES.usecaseApi);
  const usecaseEnterpriseHref = helpers.relativePagePath(ROUTES.usecaseEnterprise);
  const apiReferenceHref = helpers.relativePagePath("docs/reference/index.html");
  const sdkHref = helpers.relativePagePath("docs/how-to/react-sdk/index.html");
  const githubHref = "https://github.com/naeem-engr/IDP-Web";
  const logoHref = helpers.relativePath("assets/logos/TokenIDP.svg");

  return `
    <nav>
      <div class="container">
        <a class="logo" href="${homeHref}" aria-label="TokenIDP home">
          <img src="${logoHref}" alt="TokenIDP" />
        </a>
        <ul>
          <li class="usecases-dropdown">
            <button
            ...
            <div class="usecases-menu">
              ...
              <a href="${usecaseEnterpriseHref}">Enterprise Architecture</a>
            </div>
          </li>
          <li><a href="${docsHref}">Docs</a></li>
          <li><a href="${blogsHref}">Blog</a></li>
          <li><a href="${contactHref}">Contact</a></li>
          <li><a href="${getStartedHref}" class="nav-cta">Get Started</a></li>
        </ul>
      </div>
    </nav>
        ...
        <div class="footer-top">
          ...
          <div class="footer-col">
            ...
            <ul>
              ...
              <li><a href="${githubHref}" target="_blank" rel="noreferrer">GitHub</a></li>
            </ul>
          </div>
          <div class="footer-col">
            <h5>Company</h5>
...
export const pages = [
  {
    ...
    render: renderLandingPageTemplate,
    renderBody: renderLandingPageBody,
  },
  ...docsPages,
  {
